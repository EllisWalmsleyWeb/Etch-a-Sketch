...
function addControls() {
  ...
  copyrightText.innerHTML = `&copy; ${new Date().getFullYear()} Ellis Walmsley. All rights reserved.`;

  const githubLink = document.createElement("a");
  githubLink.href = "https://github.com/EllisWalmsleyWeb/Etch-a-Sketch";
  githubLink.target = "_blank";
  githubLink.classList.add("github-link");
  githubLink.setAttribute("aria-label", "View source code on GitHub");

  // GitHub icon using SVG
  ...
  sourceText.textContent = " View Source Code";
